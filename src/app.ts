...
export class App {
  ...
  private initializeSwaggerUI() {
    this.app.doc31('/swagger', (c) => {
      ...
      return {
        ...
        \nJioSaavn API, accessible at [saavn](https://am-saavn.vercel.app/docs), is an unofficial API that allows users to download high-quality songs from [JioSaavn](https://jiosaavn.com). 
  ...
  private initializeRouteFallback() {
    this.app.notFound((ctx) => {
      return ctx.json({ success: false, message: 'route not found, check docs at https://am-saavn.vercel.app/docs' }, 404)
    })
  }
